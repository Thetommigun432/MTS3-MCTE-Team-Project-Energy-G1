 ...
 */
export function MeterToAppliancesIllustration({
  className,
 ...
 */
export function WaveformSignalIllustration({
  className,
  accentColor = "currentColor",
}: IllustrationProps) {
  return (
 ...
 */
export function ConfidenceGaugeIllustration({
  className,
  accentColor = "currentColor",
}: IllustrationProps) {
  return (
    ...
    >
      ...
      <path d="M15 55 A35 35 0 0 1 85 55" strokeWidth="6" opacity="0.2" />

      {/* Low zone (red hint) */}
      <path d="M15 55 A35 35 0 0 1 30 28" strokeWidth="6" opacity="0.3" />

      {/* Medium zone */}
      <path d="M30 28 A35 35 0 0 1 70 28" strokeWidth="6" opacity="0.4" />
...
export function EnergyFlowIllustration({
  ...
  return (
    ...
    >
      ...
      <text x="85" y="27" fontSize="5" fill="currentColor" stroke="none">
        kWh
      </text>
 ...
 */
export function ApplianceDetectionIllustration({
  className,
  accentColor = "currentColor",
}: IllustrationProps) {
  return (
