        ...
        <section className="py-16 px-6 border-b border-border relative overflow-hidden">
          ...
          <div className="container max-w-4xl text-center relative z-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Learn how Non-Intrusive Load Monitoring disaggregates total
              building consumption into individual appliance usage.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  <strong>Non-Intrusive Load Monitoring (NILM)</strong> is an
                  AI-powered technique that analyzes the total electrical
                  consumption of a building to identify and estimate the usage
                  of individual appliances.
                </p>
                <p className="text-muted-foreground mb-4">
                  Instead of installing separate meters on each device (which is
                  expensive and intrusive), NILM uses machine learning to
                  recognize the unique electrical signatures of different
                  appliances.
                </p>
                <div className="bg-muted/50 rounded-lg p-4 border border-border">
                  <p className="text-sm text-muted-foreground">
                    <strong className="text-foreground">Key insight:</strong>{" "}
                    Each appliance has a distinctive power consumption pattern —
                    like a fingerprint — that can be detected in the aggregate
                    signal.
                  </p>
                </div>
              </div>
          ...
          <div className="container max-w-5xl">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-muted-foreground mb-4">
                  The AI continuously monitors the power consumption waveform,
                  looking for characteristic changes that indicate appliances
                  turning on or off.
                </p>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-foreground">Step changes:</strong>{" "}
                      Sudden power increases/decreases when appliances switch
                      states
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Recognizing known appliance signatures in the signal
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-primary mt-1.5 shrink-0" />
                    <span>
                      ...
                      Using usage patterns (e.g., HVAC cycles) to improve
                      accuracy
                    </span>
                  </li>
                </ul>
          ...
          <div className="container max-w-5xl">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Every prediction includes a confidence score indicating how
                  certain the model is about its estimate. This transparency
                  helps you understand the reliability of each data point.
                </p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">
                      Clear signal, high certainty (&gt;80%)
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">
                      Uncertain, overlapping signals (&lt;50%)
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="container max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="border-border">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    The model is still gathering data on this appliance.
                    Predictions may be less accurate during this initial phase.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-border">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Enough data collected. The model confidently recognizes this
                    appliance's signature and provides reliable predictions.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-border">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Signal overlap or unusual patterns detected. The model flags
                    these cases for manual review or additional training.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-12 px-6">
          <div className="container max-w-3xl">
            <Card className="border-border relative overflow-hidden">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Full API documentation and integration guides are coming soon.
                  You'll be able to:
                </p>
